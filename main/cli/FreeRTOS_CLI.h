...
#define cmdASCII_BS			( 0x08 )	// backspace('\b')
#define cmdASCII_DEL		( 0x7F )	// delete
#define cmdASCII_LF			(	0x0a )	// '\n'
#define cmdASCII_CR			(	0x0d )	// '\r'
#define ASCII_CTRL_C		(	0x03 )
#define cmdMAX_INPUT_SIZE			100		// hjjeon : 50->80->100
...
void vRegisterAmrCLICommands( void );
void vRegisterRPLCLICommands( void );
void vRegisterStackCLICommands( void );
